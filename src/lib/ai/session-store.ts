...
export interface AiSession {
  ...
  context: {
     ...
     * Used for non-PMU categories (Hydrafacial, Brows & Lashes, Microneedling, Lash Extensions)
     * where there is no `consultationTechnique` enum value. Lets us re-resolve the
     * service when the user clicks "Подобрать время и записаться" from a consultation card.
     */
