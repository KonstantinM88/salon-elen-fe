...
// function SectionTitle({ children }: SectionTitleProps): React.JSX.Element {
//   return (
//     <h3 className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-slate-950/80 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.16em] text-slate-200 shadow-[0_0_18px_rgba(15,23,42,0.9)]">
//       <span className="relative inline-flex h-1.5 w-1.5">
//         <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400/60 opacity-75" />
//         <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(34,197,94,0.9)]" />
//       </span>
//       <span>{children}</span>
//     </h3>
//   );
...
//   { href: "/services", labelKey: "nav_services", icon: Scissors },
//   { href: "/prices", labelKey: "nav_prices", icon: Tag },
//   { href: "/news", labelKey: "nav_news", icon: Newspaper },
//   { href: "/about", labelKey: "nav_about", icon: Info },
//   { href: "/contacts", labelKey: "nav_contacts", icon: MapPin },
// ];

// const clientNav: ClientNavItem[] = [
//   { href: "/booking", labelKey: "footer_client_booking", icon: CalendarCheck },
//   {
//     href: "/booking/client",
//     labelKey: "footer_client_cabinet",
//     icon: User,
...
//     bgClass: "from-[#1877F2] via-[#1d4ed8] to-[#0f172a]",
//     ringClass: "ring-sky-400/70",
//     tooltip: "Открыть страницу в Facebook",
//   },
//   {
//     href: "https://youtube.com",
//     label: "YouTube",
...
//       whileHover={{ y: -2, scale: 1.01 }}
//       transition={{ type: "spring", stiffness: 260, damping: 24 }}
//       className={`relative h-full rounded-3xl bg-gradient-to-r from-emerald-500/80 via-sky-500/80 to-fuchsia-500/80 p-[1px] shadow-[0_0_32px_rgba(16,185,129,0.55)] ${className ?? ""}`}
//     >
//       <div className="relative h-full rounded-[1.4rem] bg-slate-950/96 px-4 py-4 ring-1 ring-white/10 backdrop-blur-xl sm:px-5 sm:py-5">
...
//       animate={{ opacity: 1, y: 0 }}
//       transition={{ duration: 0.55, ease: "easeOut" }}
//       className="relative mt-16 overflow-hidden border-top border-white/5 bg-gradient-to-b from-slate-950/40 via-slate-950 to-black/95 text-sm text-slate-200"
//     >
//       {/* фоновые свечения */}
//       <div
//         aria-hidden
...
//           className="grid gap-5 border-b border-white/5 pb-8 md:grid-cols-[minmax(0,2.2fr)_minmax(0,1.4fr)]"
//         >
//           {/* левая часть - большой блок с подсветкой и кнопкой */}
//           <NeonCard>
//             <div className="relative space-y-3">
//               <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-500/10 px-2.5 py-1 text-[11px] font-medium text-emerald-100 shadow-[0_0_16px_rgba(34,197,94,0.5)] backdrop-blur">
//                 <Sparkles className="h-3.5 w-3.5 text-emerald-300" />
...
//               <h2 className="text-lg font-semibold leading-snug text-slate-50 sm:text-xl">
//                 Ваш салон красоты с онлайн-записью и заботой о деталях
//               </h2>

//               <p className="text-xs leading-relaxed text-slate-300 sm:text-sm">
//                 Профессиональные мастера, современные техники и по-настоящему
//                 тёплая атмосфера — мы помогаем чувствовать себя уверенно каждый
//                 день. Запись занимает пару минут, а эффект — надолго.
//               </p>
...
//                 <div className="inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2 py-1 text-[11px] text-slate-200 ring-1 ring-sky-400/40">
//                   <Sparkles className="h-3.5 w-3.5 text-sky-300" />
//                   <span>Премиальный подход к сервису</span>
//                 </div>
//               </div>
...
//           {/* правая часть - быстрые подсказки записи */}
//           <div className="flex flex-col gap-3">
//             <NeonCard>
//               <div className="space-y-2 text-xs text-slate-200">
//                 <p className="font-semibold text-slate-50">
//                   Записаться можно в пару кликов
//                 </p>
//                 <p className="text-[11px] text-slate-300">
//                   Онлайн-запись работает круглосуточно, а мы подтвердим ваш
//                   визит максимально быстро.
//                 </p>
//                 <ol className="mt-2 space-y-1">
//                   <li className="inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2 py-1 ring-1 ring-emerald-400/40">
//                     <span className="h-4 w-4 rounded-full bg-emerald-500 text-[10px] font-semibold text-black flex items-center justify-center">
//                       1
//                     </span>
//                     <span>Выберите услугу</span>
//                   </li>
//                   <li className="inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2 py-1 ring-1 ring-sky-400/40">
//                     <span className="h-4 w-4 rounded-full bg-sky-500 text-[10px] font-semibold text-black flex items-center justify-center">
//                       2
//                     </span>
//                     <span>Выберите мастера</span>
//                   </li>
//                   <li className="inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2 py-1 ring-1 ring-fuchsia-400/40">
//                     <span className="h-4 w-4 rounded-full bg-fuchsia-500 text-[10px] font-semibold text-black flex items-center justify-center">
//                       3
//                     </span>
//                     <span>Подтвердите время</span>
//                   </li>
//                 </ol>
//               </div>
//             </NeonCard>
...
//                   <span>Онлайн-запись премиум-класса</span>
//                 </div>
//                 <div className="inline-flex items-center gap-2 rounded-2xl bg-black/40 px-3 py-2 ring-1 ring-sky-400/40">
//                   <Phone className="h-4 w-4 text-sky-300" />
//                   <span>Удобные слоты под ваш график</span>
//                 </div>
//               </div>
//             </NeonCard>
//           </div>
...
//                       className="group inline-flex items-center gap-2 rounded-lg px-1 py-0.5 text-slate-300 transition hover:text-sky-100"
//                     >
//                       <span className="flex h-7 w-7 items-center justify-center rounded-full bg-black/60 ring-1 ring-white/10">
...
//---------почти съязыками немного другой пример
// "use client";
...
//   {
//     href: "/for-masters",
//     label: "Сотрудничество с мастерами",
//     icon: ShieldCheck,
//     glowClass: "from-emerald-400 via-teal-400 to-sky-400",
//     ringClass: "shadow-[0_0_16px_rgba(45,212,191,0.9)]",
//   },
...
// function SectionTitle(props: SectionTitleProps): React.JSX.Element {
//   return (
//     <h3 className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-slate-950/70 px-3 py-1 text-xs font-medium uppercase tracking-[0.16em] text-slate-200 shadow-[0_0_18px_rgba(15,23,42,0.9)] backdrop-blur-md">
//       <span className="relative inline-flex h-1.5 w-1.5">
//         <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400/60 opacity-75" />
//         <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(34,197,94,0.9)]" />
//       </span>
...
// function ColumnCard(props: CardProps): React.JSX.Element {
//   return (
//     <div
//       className={`relative rounded-3xl border border-white/8 bg-slate-950/60 px-4 py-4 shadow-[0_0_24px_rgba(15,23,42,0.9)] ring-1 ring-white/5 backdrop-blur-xl sm:px-5 sm:py-5 ${
//         props.className ?? ""
//       }`}
//     >
//       {props.children}
//       <div className="pointer-events-none absolute inset-0 rounded-3xl border border-white/5/40 mix-blend-soft-light" />
//     </div>
//   );
// }
...
//       {/* Основной контейнер */}
//       <div className="relative mx-auto max-w-6xl px-4 pb-8 pt-10 sm:px-6 sm:pb-10 sm:pt-12 lg:px-8 lg:pb-12 lg:pt-14">
//         {/* Верхний блок с описанием и акцентом */}
//         <motion.div
//           variants={fadeInUp}
//           initial="hidden"
//           animate="visible"
...
//             className="relative max-w-xl rounded-3xl bg-gradient-to-r from-emerald-500/90 via-sky-500/90 to-fuchsia-500/90 p-[1px] shadow-[0_0_32px_rgba(16,185,129,0.55)]"
//           >
//             <div className="relative space-y-3 rounded-[1.45rem] bg-slate-950/98 px-4 py-4 ring-1 ring-white/10 backdrop-blur-xl sm:px-5 sm:py-5">
//               {/* мягкий градиент внутри */}
//               <div className="pointer-events-none absolute inset-0 rounded-[1.45rem] bg-gradient-to-br from-emerald-500/10 via-sky-500/10 to-fuchsia-500/10 mix-blend-soft-light" />
...
//                 className="flex flex-wrap items-center gap-2 text-[11px] text-slate-300 sm:text-xs"
//               >
//                 <div className="inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2 py-1 ring-1 ring-emerald-400/40">
//                   <CalendarCheck className="h-3.5 w-3.5 text-emerald-300" />
//                   <span>Онлайн-запись 24/7</span>
//                 </div>
//                 <div className="inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2 py-1 ring-1 ring-sky-400/40">
//                   <Sparkles className="h-3.5 w-3.5 text-sky-300" />
//                   <span>Премиальный подход к сервису</span>
//                 </div>
//               </motion.div>
...
//           {/* Правый блок с мини-CTA и иконками */}
//           <div className="relative flex flex-col gap-3 sm:gap-4">
//             <motion.div
//               variants={fadeInUp}
//               transition={{ duration: 0.45, delay: 0.08 }}
//               className="inline-flex items-center gap-2 rounded-2xl border border-emerald-400/30 bg-gradient-to-r from-emerald-500/10 via-sky-500/10 to-fuchsia-500/10 px-3 py-2 text-xs text-slate-100 shadow-[0_0_20px_rgba(34,197,94,0.5)] backdrop-blur-xl"
//             >
//               <div className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-slate-950/80 ring-1 ring-emerald-400/40">
//                 <CalendarCheck className="h-4 w-4 text-emerald-300" />
//               </div>
//               <div className="space-y-0.5">
...
//               className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-slate-950/80 px-3 py-1.5 text-[11px] tracking-[0.16em] text-slate-300 shadow-[0_0_16px_rgba(15,23,42,0.9)]"
//             >
...
//             >
//               <div className="flex flex-1 items-center gap-2 rounded-2xl border border-white/10 bg-slate-950/80 px-3 py-1.5 shadow-[0_0_16px_rgba(15,23,42,0.9)]">
//                 <Clock className="h-4 w-4 text-emerald-300" />
//                 <div className="space-y-0.5 leading-tight">
//                   <p className="font-medium text-slate-100">
//                     Удобные слоты записи
//                   </p>
//                   <p className="text-[11px] text-slate-300">
...
//         {/* Основная часть: сетка 4 колонки */}
//         <motion.div
//           variants={fadeInUp}
//           initial="hidden"
//           animate="visible"
...
//           {/* Колонка: для клиентов и мастеров */}
//           <motion.div
//             variants={fadeInUp}
...
//                 className="mt-3 rounded-2xl border border-emerald-400/30 bg-emerald-500/5 p-2 text-[11px] text-emerald-100 shadow-[0_0_14px_rgba(16,185,129,0.5)]"
//               >
//                 <p>
//                   Ищете комфортные условия работы и атмосферу, где ценят
//                   качество? Напишите нам — обсудим сотрудничество.
//                 </p>
//               </motion.div>
//             </ColumnCard>
//           </motion.div>
...
//           className="mt-10 flex flex-col gap-3 border-t border-white/5 pt-4 text-[11px] text-slate-400 sm:flex-row sm:items-center sm:justify-between"
//         >
//           <p>© {year} Salon Elen. {t("footer_copyright")}</p>
//           <div className="flex flex-wrap items-center gap-3">
...
// function SocialsSectionDesktop(): React.JSX.Element {
//   const t = useTranslations();
...
// function SocialsSectionMobile(): React.JSX.Element {
//   const t = useTranslations();
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="group inline-flex flex-1 items-center gap-2 rounded-2xl border border-white/10 bg-slate-950/80 px-3 py-2 text-xs text-slate-200 shadow-[0_0_16px_rgba(15,23,42,0.9)] transition hover:border-sky-400/60 hover:text-sky-50"
//             >
//               <span
//                 className={`inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-gradient-to-br ${social.bgClass} ring-2 ${social.ringClass} shadow-[0_0_18px_rgba(56,189,248,0.7)]`}
//               >
