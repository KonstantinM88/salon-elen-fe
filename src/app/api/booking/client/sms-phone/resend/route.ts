...
//  * Генерирует новый PIN, хеширует, обновляет в БД, отправляет SMS через Zadarma
//  */
...
//     // Отправка нового PIN через SMS via Zadarma
//     const sendResult = await sendPinSms(registration.phone, newPin);
...
//--------работал для Mobizon SMS, закомментирован для Zadarma SMS -------
// // src/app/api/booking/client/sms-phone/resend/route.ts
// import { NextRequest, NextResponse } from 'next/server';
// import { prisma } from '@/lib/prisma';
// import { generatePinCode, sendPinSms } from '@/lib/mobizon-sms';
// import bcrypt from 'bcrypt';
...
//--------работал для INFOBIP SMS, закомментирован для Zadarma SMS -------
// // src/app/api/booking/client/sms-phone/resend/route.ts
// import { NextRequest, NextResponse } from 'next/server';
// import { prisma } from '@/lib/prisma';
// import {
