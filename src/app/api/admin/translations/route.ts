...
//     // ✅ ИСПРАВЛЕНО: правильная проверка роли
//     if (!session?.user) {
...
//     // Type assertion для доступа к role
...
//     const { serviceId, translations } = body as {
//       serviceId: string;
//       translations: Translation[];
//     };

//     if (!serviceId || !Array.isArray(translations)) {
//       return NextResponse.json(
