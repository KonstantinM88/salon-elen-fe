...
//------------добавляю телегу в главный список--------
// // src/app/booking/client/ClientPageWithGoogleOption.tsx
// // ОБНОВЛЕНО: SMS-карточка теперь на 2-й позиции (в середине)
// "use client";
...
// import { motion } from "framer-motion";
// import { FcGoogle } from "react-icons/fc";
// import { Crown, Sparkles, Star, Zap, Check, Shield, Edit, Phone } from "lucide-react";
// import { BookingAnimatedBackground } from "@/components/layout/BookingAnimatedBackground";
// import PremiumProgressBar from "@/components/PremiumProgressBar";
// import { useTranslations } from "@/i18n/useTranslations";
...
//   // Слушаем завершение регистрации из popup (страница ввода телефона)
//   React.useEffect(() => {
//     const handleMessage = (event: MessageEvent) => {
//       if (typeof window === "undefined") return;
//       if (event.origin !== window.location.origin) return;
...
//             {/* Три ПРЕМИУМ карточки - ПОРЯДОК ИЗМЕНЁН: Google, SMS, Form */}
...
//               {/* ==================== КАРТОЧКА 2: SMS (ПЕРЕСТАВЛЕНА С 3-Й ПОЗИЦИИ) ==================== */}
//               <motion.div
//                 initial={{ opacity: 0, y: 30 }}
//                 animate={{ opacity: 1, y: 0 }}
//                 transition={{ delay: 0.4 }}
...
//                     <div className="grid h-full grid-rows-[auto_auto_auto_1fr_auto] gap-5">
//                       {/* 1. ПРЕМИУМ иконка Phone с пульсацией */}
//                       <div className="flex justify-center">
//                         <div className="relative">
//                           {/* Пульсирующие кольца */}
//                           <motion.div
...
//               {/* ==================== КАРТОЧКА 3: ФОРМА (ПЕРЕСТАВЛЕНА СО 2-Й ПОЗИЦИИ) ==================== */}
//               <motion.div
//                 initial={{ opacity: 0, x: 30 }}
//                 animate={{ opacity: 1, x: 0 }}
//                 transition={{ delay: 0.5 }}
...
//---------переводим и переставляем смс на вторую позицию------
// // src/app/booking/client/ClientPageWithGoogleOption.tsx
// "use client";
...
//                         className="text-center text-base text-slate-200/90 lg:text-lg"
//                       >
//                         Получите PIN код через SMS
//                       </motion.p>

//                       {/* 4. Список преимуществ */}
//                       <div className="flex min-h-[160px] flex-col justify-start space-y-3">
//                         {[
//                           { text: "PIN код по SMS", icon: "📱" },
//                           { text: "Без email регистрации", icon: "⚡" },
//                           { text: "Быстро и безопасно", icon: "🛡️" },
//                           { text: "4-значный код", icon: "🔢" },
//                         ].map((benefit, i) => (
//                           <motion.div
//                             key={benefit.text}
//                             initial={{ opacity: 0, x: -20 }}
...
//----------всё работает, добовляем верификацию через смс---------
// // src/app/booking/client/ClientPageWithGoogleOption.tsx
// "use client";
...
//-----------всё работает обновляем в связи с добавлением телефона при регистрации через гугл---
// // src/app/booking/client/ClientPageWithGoogleOption.tsx
// "use client";
