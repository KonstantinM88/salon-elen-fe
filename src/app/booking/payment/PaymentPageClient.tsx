...
//--------------на iOS добовлял только гугл календарь на второй не реагировал, добовляю новое скачивание---
// // src/app/booking/payment/PaymentPageClient.tsx
// "use client";
...
//       if (isIOS) {
//         // ✅ iOS: Используем data URL с text/calendar MIME типом
//         // Кодируем в base64 для надёжности
//         const base64Content = btoa(unescape(encodeURIComponent(icsContent)));
//         const dataUrl = `data:text/calendar;base64,${base64Content}`;
        
//         console.log('📅 iOS: Opening data URL with .ics content');
        
//         // Открываем в текущей вкладке - Safari должен распознать text/calendar
//         window.location.href = dataUrl;
        
//       } else {
//         // Desktop/Android: Создаём Blob и скачиваем файл
//         const icsBlob = new Blob([icsContent], { type: 'text/calendar;charset=utf-8' });
//         const url = window.URL.createObjectURL(icsBlob);
//         const link = document.createElement('a');
//         link.href = url;
