...
export default function ServicesPage(): React.JSX.Element {
  ...
  // Auto-select service from URL param (?preselect=ID)
  ...
  useEffect(() => {
    ...
    const exists = groups.some((g) =>
      g.services.some((s) => s.id === preselectId),
    );
    if (exists) {
      setSelectedServices([preselectId]);
    }
  }, [preselectId, groups]); // eslint-disable-line react-hooks/exhaustive-deps
...
//-----------09.02.26 исправляем для мобильной версии выбраной услуги
// // src/app/booking/(steps)/services/ServicesStepClient.tsx
// //------была
// // src/app/booking/(steps)/services/page.tsx
// // страница выбора услуг в многошаговом бронировании
...
//-------09.02.26 переход от с выбором услуг
// // src/app/booking/(steps)/services/ServicesStepClient.tsx
// //------была
// // src/app/booking/(steps)/services/page.tsx
// // страница выбора услуг в многошаговом бронировании
