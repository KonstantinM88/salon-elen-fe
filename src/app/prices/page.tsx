...
export async function generateMetadata({
  ...
  const alts = buildAlternates("/prices", locale);
...
function buildJsonLd(locale: SeoLocale, services: ServiceForLd[]) {
  const alts = buildAlternates("/prices", locale);
...
async function getCategories(locale: SeoLocale) {
...
//-----добавляем прямую ссылку карточки на бухунг
// // src/app/prices/page.tsx
// import type { Metadata } from "next";
// import { cookies } from "next/headers";
// import { prisma } from "@/lib/db";
